    ...
    try {
      ...
      const updateData = {
        trip_details: {
          ...
          currency: originalItinerary.trip_details.currency || 'USD',
          trip_type: originalItinerary.trip_details.trip_type || 'round-trip'
        },
        preferences: formData.preferences,
        // Preserve existing AI data and budget breakdown
        ai_generated_plan: originalItinerary.ai_generated_plan,
        budget_breakdown: originalItinerary.budget_breakdown,
        status: originalItinerary.status,
        metadata: {
          ...originalItinerary.metadata,
