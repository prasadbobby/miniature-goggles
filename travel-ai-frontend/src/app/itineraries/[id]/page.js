      ...
      <div className="text-center py-12">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mt-6 max-w-md mx-auto">
          <p className="text-blue-800 text-sm">
            <strong>Note:</strong> Daily schedules are generated by AI based on your destination, 
            preferences, and travel style. This includes morning, afternoon, and evening activities 
            plus meal recommendations.
          </p>
        </div>
      </div>
    );
          ...
          <div key={day.day} className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="text-right">
                ...
                <p className="font-semibold text-gray-900">{formatCurrency(day.budget_allocated)}</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-orange-50 rounded-lg p-4 border border-orange-200">
                ...
                <p className="text-orange-700 text-sm">{day.morning}</p>
              </div>
              <div className="bg-blue-50 rounded-lg p-4 border border-blue-200">
                ...
                <p className="text-blue-700 text-sm">{day.afternoon}</p>
              </div>
              <div className="bg-purple-50 rounded-lg p-4 border border-purple-200">
                ...
                <p className="text-purple-700 text-sm">{day.evening}</p>
              </div>
            </div>
              ...
              <div className="mt-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                  <div className="border border-gray-200 rounded-lg p-3">
                    ...
                    <p className="text-gray-600 text-sm mt-1">{day.meals.breakfast}</p>
                  </div>
                  <div className="border border-gray-200 rounded-lg p-3">
                    <span className="font-medium text-gray-900 text-sm flex items-center">
                      <span className="mr-2">🍽️</span>
                    ...
                    <p className="text-gray-600 text-sm mt-1">{day.meals.lunch}</p>
                  </div>
                  <div className="border border-gray-200 rounded-lg p-3">
                    <span className="font-medium text-gray-900 text-sm flex items-center">
                      <span className="mr-2">🍷</span>
                    ...
                    <p className="text-gray-600 text-sm mt-1">{day.meals.dinner}</p>
                  </div>
                </div>
              </div>
            )}
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-gradient-to-r from-blue-50 to-blue-100 rounded-xl p-6 border border-blue-200">
        <h3 className="text-lg font-semibold text-blue-900 mb-4">💡 Budget Tips</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-white/50 rounded-lg p-3">
            <p className="text-sm text-blue-800">
              <strong>Save on Flights:</strong> Book 6-8 weeks in advance and consider flexible dates.
            </p>
          </div>
          <div className="bg-white/50 rounded-lg p-3">
            <p className="text-sm text-blue-800">
              <strong>Accommodation:</strong> Mix hotel stays with apartments for longer trips.
            </p>
          </div>
          <div className="bg-white/50 rounded-lg p-3">
            <p className="text-sm text-blue-800">
              <strong>Local Food:</strong> Try street food and local markets for authentic experiences.
            </p>
          </div>
          <div className="bg-white/50 rounded-lg p-3">
            <p className="text-sm text-blue-800">
              <strong>Transportation:</strong> Use public transport and walk when possible.
            </p>
          </div>
        </div>
      </div>
              ...
              <div>
                ...
                <div className="flex flex-wrap items-center gap-6 text-white/90">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span>{trip_details.travelers} {trip_details.travelers === 1 ? 'traveler' : 'travelers'}</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <CurrencyDollarIcon className="h-5 w-5" />
                    <span>{formatCurrency(trip_details.total_budget)}</span>
                  </div>
                </div>
              </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div>
              ...
              {ai_generated_plan?.flights && ai_generated_plan.flights.length > 0 ? (
                  ...
                  {ai_generated_plan.flights.map((flight, index) => (
                    <div key={index} className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                      <div className="flex items-center justify-between mb-4">
                        ...
                        <div className="text-right">
                          <p className="text-2xl font-bold text-gray-900">{formatCurrency(flight.price)}</p>
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8 text-center">
                  ...
                  <h3 className="text-lg font-medium text-gray-900 mb-2">No Flight Data Available</h3>
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    <p className="text-blue-800 text-sm">
                      ...
                      flight data would be fetched from real airline APIs like Amadeus, Skyscanner, 
                      or airline direct APIs based on your destination and travel dates.
                    </p>
                  </div>
                </div>
              )}
            ...
            <div>
              ...
              {ai_generated_plan?.accommodations && ai_generated_plan.accommodations.length > 0 ? (
                      ...
                      <div className="flex items-start space-x-4">
                        ...
                        <div className="flex-1">
                          <div className="flex items-start justify-between">
                            ...
                            <div className="text-right">
                              <p className="text-2xl font-bold text-gray-900">{formatCurrency(accommodation.total_price)}</p>
                              <p className="text-sm text-gray-600">{formatCurrency(accommodation.price_per_night)}/night</p>
                            </div>
                          </div>
               ...
               <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8 text-center">
                 ...
                 <h3 className="text-lg font-medium text-gray-900 mb-2">No Accommodation Data Available</h3>
                 <p className="text-gray-600 mb-4">
                   Hotel recommendations will be generated based on your preferences and budget.
                 </p>
                 <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                   <p className="text-green-800 text-sm">
                     <strong>Note:</strong> In production, this would show curated hotel options 
                     from booking platforms like Booking.com, Expedia, Hotels.com, or direct hotel APIs 
                     based on your destination, dates, and accommodation preferences.
                   </p>
                 </div>
               </div>
             )}
           ...
           <div>
             ...
             {ai_generated_plan?.activities && ai_generated_plan.activities.length > 0 ? (
                     ...
                     <div className="flex items-start space-x-4">
                       ...
                       <div className="flex-1">
                         <div className="flex items-start justify-between mb-2">
                           ...
                           <span className="text-sm font-medium text-gray-900">{formatCurrency(activity.price)}</span>
                         </div>
               ...
               <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8 text-center">
                 ...
                 <h3 className="text-lg font-medium text-gray-900 mb-2">No Activities Data Available</h3>
                 <p className="text-gray-600 mb-4">
                   Activity recommendations will be generated based on your travel style and interests.
                 </p>
                 <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
                   <p className="text-purple-800 text-sm">
                     <strong>Note:</strong> Activities would be sourced from platforms like 
                     GetYourGuide, Viator, TripAdvisor Experiences, or local tourism APIs 
                     based on your destination and travel preferences.
                   </p>
                 </div>
               </div>
             )}
       ...
       {activeTab === 'budget' && (
         <BudgetBreakdown 
           ...
           totalBudget={trip_details.total_budget}
         />
       )}
     </div>
   </div>
